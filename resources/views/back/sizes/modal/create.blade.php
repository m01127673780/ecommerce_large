...
<div class="modal fade bd-example-modal-lg" id="createNewsize" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                ...
                <div class="container-fluid">
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <center class="box-title"><h3 class="head_title">{{ trans('admin.create_size') }}</h3></center>
                        </div>
                        <section class="modal_massage"> @include('back.message_error') </section>
                          <!-- /.box-header ,'required'=>'required' -->
                            <!-- /.----------------------------------------------------------------- -->
                                <div class="box-body">
                                    {!! Form::open(['url'=>aurl('sizes/create_quick'),'files'=>true]) !!}
