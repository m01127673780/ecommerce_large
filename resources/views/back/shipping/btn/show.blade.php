...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#show_shipping{{ $id }}"><i class="fa fa-eye"></i></button>
<!-- Modal -->
<div id="show_shipping{{ $id }}" class="modal  modal fade bd-example-modal-lg    fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- /.----------------------------------------------------------------- -->
                {{-- {!! Form::open(['route'=>['shipping.update',$shipping->id],'method'=>'put']) !!}--}}
                {!! Form::open(['url'=>aurl('shipping/'.$id),'method'=>'get']) !!}
