                                    ...
                                    <section class="all_fildes_page_edit">
                                        ...
                                        <aside class="row model_actions">
                                            <div class="col-md-12 content_btn-actions_model">
                                                <!-- /.---------- -->
                                                <a href="{{ aurl('flavors/'.$flavor->id.'/edit') }}" class="btn btn-success "><i class="fa fa-edit"></i> {{trans('admin.edit_page')}}</a>
                                                <span>
                                                {!! Form::open(['route'=>['flavors.destroy',$flavor->id],'method'=>'delete' ,'class'=>'d-inline-block']) !!}
                                                ...
                                                <a href="{{aurl('flavors')}}" type="button" class="btn btn-warning" data-dismiss="modal">{{ trans('admin.close') }}  <i class="fas fa-times"> </i> </a></button>
                                                <!-- /.----------------------------------------------------------------- -->
                                            </div><!--col-md-12-->
