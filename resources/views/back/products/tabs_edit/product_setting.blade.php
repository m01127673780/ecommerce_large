 ...
 @endpush
  ...
  <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
        ...
        {!! Form::text('product_name_en',$product->product_name_en,['class'=>'form-control datepicker','placeholder'=>trans('admin.product_name_en')]) !!}
  </div> <!-- /product_name_ar" -->  
              
  <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
        {!! Form::label('product_name_ar',trans('admin.product_name_ar')) !!}
        {!! Form::text('product_name_ar',$product->product_name_ar,['class'=>'form-control datepicker','placeholder'=>trans('admin.product_name_ar')]) !!}
  </div> <                  
  <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
        {!! Form::label('desc_en',trans('admin.desc_en')) !!}
        {!! Form::text('desc_en',$product->desc_en,['class'=>'form-control datepicker','placeholder'=>trans('admin.desc_en')]) !!}
  </div> <!-- /desc_ar" -->  
              
  <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
        {!! Form::label('desc_ar',trans('admin.desc_ar')) !!}
        {!! Form::text('desc_ar',$product->desc_ar,['class'=>'form-control datepicker','placeholder'=>trans('admin.desc_ar')]) !!}
  </div> <!-- /desc_ar" -->  
